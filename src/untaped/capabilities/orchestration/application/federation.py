...
from untaped.capabilities.orchestration.application.view_management import finalize_views
...
from untaped.capabilities.orchestration.domain.ids import StoreId
from untaped.capabilities.orchestration.domain.models import Registry, RegistryChild, Revision
...
_MISSING_STORE_ERRORS = (FileNotFoundError, StoreDiscoveryMissing)
_CHANGED_STORE_ERRORS = (
    FileNotFoundError,
    StoreDiscoveryMissing,
    StoreDiscoveryInvalid,
)
