...
from untaped.capabilities.orchestration.application.item_support import ItemMutationResult
...
from untaped.capabilities.orchestration.cli.options import OutputFormat, validate_format
from untaped.capabilities.orchestration.domain.curation import CurationEntry
...
def _typed_diagnostics(error: Exception) -> tuple[Diagnostic, ...] | None:
    ...
    if (
        ...
        return cast("tuple[Diagnostic, ...]", diagnostics)
    return None
