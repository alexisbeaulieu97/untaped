...
from untaped.capabilities.workspace.application.ports import EditorRunner
...
class EditWorkspace:
    ...
    def __call__(self, workspace: Workspace, *, argv: Sequence[str]) -> int:
        ...
        in :func:`untaped.capabilities.workspace.infrastructure.system_adapters.resolve_editor_argv`
