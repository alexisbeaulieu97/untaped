...
from untaped.capabilities.awx.application.get_resource import resolve_identity
from untaped.capabilities.awx.application.ports import (
    ResourceClient,
    WorkflowNodeRepository,
)
from untaped.capabilities.awx.domain import ResourceSpec, WorkflowNode, normalise_unified_job_type
