...
from untaped.capabilities.orchestration.application.ports import (
    StoreLockTimeout as ApplicationStoreLockTimeout,
)
...
from untaped.capabilities.orchestration.infrastructure.locking import (
    FileLockManager,
    StoreLockTimeout,
)
...
def test_multiple_lock_acquisitions_share_one_total_deadline(
    ...
    monkeypatch.setattr(
        "untaped.capabilities.orchestration.infrastructure.locking.FileLock",
        RecordingLock,
    )
