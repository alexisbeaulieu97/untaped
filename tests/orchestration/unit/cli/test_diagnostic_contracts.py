...
import pytest
from orchestration.builders import DECISION_ID, write_store

from untaped.capabilities.orchestration.application.bootstrap import InitConflictError
from untaped.capabilities.orchestration.application.federation import (
    RegistryMutationConflict,
    RegistryRevisionConflict,
    UnidentifiedStoreError,
)
from untaped.capabilities.orchestration.application.import_operations import ImportConflict
from untaped.capabilities.orchestration.application.item_support import (
    CreateConflict,
    ItemStateConflict,
    RelationConflict,
    RevisionConflict,
...
from untaped.capabilities.orchestration.application.mutations import InvalidMutationState
from untaped.capabilities.orchestration.application.queries import (
    QueryIncompleteError,
    RawAmbiguityError,
)
from untaped.capabilities.orchestration.application.repair_operations import RepairConflict
from untaped.capabilities.orchestration.application.results import StoreLocation
from untaped.capabilities.orchestration.cli import app
from untaped.capabilities.orchestration.cli.context import CliContext
from untaped.capabilities.orchestration.cli.output import run_command
from untaped.capabilities.orchestration.domain.diagnostics import Diagnostic
from untaped.capabilities.orchestration.infrastructure.codec import CodecError
from untaped.capabilities.orchestration.infrastructure.filesystem import (
    PathSafetyError,
    StoreNotFoundError,
)
...
def test_view_failure_is_typed_orc008() -> None:
    from untaped.capabilities.orchestration.infrastructure import views
...
def test_query_resolution_failure_is_typed_orc003() -> None:
    from untaped.capabilities.orchestration.application import queries
...
def test_diagnostic_error_carries_an_exact_tuple() -> None:
    from untaped.capabilities.orchestration.domain import diagnostics
