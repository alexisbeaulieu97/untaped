...
from untaped.capabilities.workspace.cli.ux_commands import _workspace_row
...
HAND_BUILT_ROW_SOURCES: list[tuple[str, Callable[[], dict[str, object]], str]] = [
    (
        "untaped.capabilities.workspace.cli.ux_commands._workspace_row",
...
_LIST_COMMAND_CALLSITES: list[tuple[Path, str, str]] = [
    (
        _REPO_ROOT / "src/untaped/capabilities/workspace/cli/ux_commands.py",
        "list_command",
        "_workspace_row",
    ),
]
